...
<Section title="Pattern" open><Slider label="Size" value={n(p,'size',40)} min={10} max={200} step={1} onChange={v=>u('size',v)}/><Slider label="Stroke Width" value={n(p,'strokeWidth',2)*10} min={1} max={100} step={1} onChange={v=>u('strokeWidth',v/10)}/><Slider label="Opacity" value={n(p,'opacity',1)*100} min={5} max={100} step={1} onChange={v=>u('opacity',v/100)}/><AngleSlider label="Rotation" value={n(p,'angle',0)} onChange={v=>u('angle',v)}/></Section>
